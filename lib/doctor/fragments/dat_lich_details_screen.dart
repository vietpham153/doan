...
class DatLichDetailsScreenD extends StatefulWidget {
  const DatLichDetailsScreenD({super.key});

  @override
  State<DatLichDetailsScreenD> createState() => _DatLichDetailsState();
}

class _DatLichDetailsState extends State<DatLichDetailsScreenD> {
  bool morning1 = true;
  bool morning2 = true;
  bool morning3 = true;
  bool morning4 = true;
